package tec.poo.proyectodos.cards.gui;

import tec.poo.proyectodos.cards.Card;
...
public class JCard extends Card {
    ...
    public static final ImageIcon DEFAULT_BACK_IMAGE = new ImageIcon(JCard.class.getResource(DEFAULT_IMAGE_DIRECTORY + "/b1fv.png"));
     ...
     * @param frontImage image to display when card is face up
     */
    public JCard(int rank, Suit suit, URL frontImage) {
    ...
    private static URL defaultImageName(int rank, Suit suit) {
        // infer the filename from rank and suit
        return JCard.class.getResource(DEFAULT_IMAGE_DIRECTORY + "/" + new Card(rank, suit).toString() + ".png");
    }
